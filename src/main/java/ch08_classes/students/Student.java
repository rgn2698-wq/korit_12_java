...
public class Student {
    ...
    // studentCode, name, score를 매개변수로 하는 매개변수 생성자를 정의 및 출력
    ...
    // 학생의 정보가 출력될 수 있도록 하는 showInfo() 메서드를 call1() 타입으로 정의
    public void showInfo() {
        System.out.println("학번: " + studentCode + " | 이름: " + name + " | 성적: " + score);
    }
}
